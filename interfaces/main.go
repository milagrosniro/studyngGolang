...
// interface type
//adentro recibe funciones
//toda struct que tenga esas funciones cumple con la interface
...
//esta funcion recibe un puntero a la struct Dog
...
func main() {
	...
	//le paso la referencia a dog, pq el tipo Animal debe ser un pointer
	Riddle(&dog)
